...
## data
   ...
   - `trials.csv`
      ...
      -  **TrialIndex**
      -  **TrialStart**,**TrialVisualizationStart**,**TrialVisualizationEnd**,**TrialAnswerStart**,**TrialAnswerEnd**,**TrialFeedbackStart**,**TrialEnd**: timestamps for each trial, the response time is the differentce between **TrialAnswerStart** - **TrialVisualizationStart**
      ...
      -  **Step**,**BinIndex**,**BinLower**,**BinUpper**,**File**: the refering 
